...
namespace WebQACustomerArea.Controllers
{
    public class TimKiemController : Controller
    {
        ...
        public ActionResult KetQuaTimKiem(string tukhoa, int? page)
        {
            ...
            List<Product> listkq = db.Products.Where(n => n.Product_Name.Contains(tukhoa)
            //|| n.Product_Show.Contains(tukhoa)
            || n.Product_Price.ToString().Contains(tukhoa) || n.Product_Unit.Contains(tukhoa)).ToList();
